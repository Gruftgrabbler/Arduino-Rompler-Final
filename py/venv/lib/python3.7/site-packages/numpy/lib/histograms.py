...
def histogramdd(sample, bins=10, range=None, normed=None, weights=None,
    ...
    sample : (N, D) array, or (D, N) array_like
        ...
        Note the unusual interpretation of samples when an array_like:
    ...
    weights : (N,) array_like, optional
        An array of values `w_i` weighing each samples `(x_i, y_i, z_i, ...)`.
    ...
    -------
    H : ndarray
        The multidimensional histogram of samples x. See normed and weights
    ...
    # Compute the bin number each samples falls into.
    Ncount = tuple(
    ...
    # Compute the samples indices in the flattened histogram matrix.
