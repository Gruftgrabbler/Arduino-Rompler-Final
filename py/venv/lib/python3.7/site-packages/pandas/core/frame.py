...
"""
    ...
    def cov(
        ...
        core.window.ExponentialMovingWindow.cov: Exponential weighted samples covariance.
        core.window.Expanding.cov : Expanding samples covariance.
        core.window.Rolling.cov : Rolling samples covariance.
