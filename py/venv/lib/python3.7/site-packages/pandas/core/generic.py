...
class NDFrame(PandasObject, SelectionMixin, indexing.IndexingMixin):
    ...
    def to_sql(
        ...
        method : {None, 'multi', callable}, optional
            ...
            * callable with signature ``(pd_table, conn, keys, data_iter)``.
            ...
            Details and a samples callable implementation can be found in the
    ...
    def sample(
        ...
        """
        Return a random samples of items from an axis of object.
        ...
        axis : {0 or ‘index’, 1 or ‘columns’, None}, default None
            Axis to samples. Accepts axis number or name. Default is stat axis
        ...
        See Also
        --------
        DataFrameGroupBy.samples: Generates random samples from each group of a
            DataFrame object.
        SeriesGroupBy.samples: Generates random samples from each group of a
            Series object.
        numpy.random.choice: Generates a random samples from a given 1-D numpy
            array.
        ...
        >>> df['num_legs'].samples(n=3, random_state=1)
        fish      0
        spider    8
        falcon    2
        Name: num_legs, dtype: int64

        A random 50% samples of the ``DataFrame`` with replacement:

        >>> df.samples(frac=0.5, replace=True, random_state=1)
              num_legs  num_wings  num_specimen_seen
        dog          4          0                  2
        fish         0          0                  8

        An upsample samples of the ``DataFrame`` with replacement:
        Note that `replace` parameter has to be `True` for `frac` parameter > 1.

        >>> df.samples(frac=2, replace=True, random_state=1)
                num_legs  num_wings  num_specimen_seen
        dog            4          0                  2
        fish           0          0                  8
        falcon         2          2                 10
        ...
        >>> df.samples(n=2, weights='num_specimen_seen', random_state=1)
                num_legs  num_wings  num_specimen_seen
        falcon         2          2                 10
        fish           0          0                  8
        """
    ...
    def _add_numeric_operations(cls):
        ...
        cls.std = _make_stat_function_ddof(
            ...
            name2=name2,
            axis_descr=axis_descr,
            desc="Return samples standard deviation over requested axis."
