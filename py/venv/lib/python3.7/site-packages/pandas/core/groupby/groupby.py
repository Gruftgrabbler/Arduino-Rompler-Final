...
class _GroupBy(PandasObject, SelectionMixin, Generic[FrameOrSeries]):
    ...
    def _get_indices(self, names):
        ...
        if len(self.indices) > 0:
            ...
            index_sample = None  # Dummy samples
...
class GroupBy(_GroupBy[FrameOrSeries]):
    ...
    **Attributes**
    ...
    def sample(
        ...
        """
        Return a random samples of items from each group.
        ...
        See Also
        --------
        DataFrame.samples: Generate random samples from a DataFrame object.
        numpy.random.choice: Generate a random samples from a given 1-D numpy
            array.
        ...
        >>> df.groupby("a").samples(n=1, random_state=1)
               a  b
        4  black  4
        2   blue  2
        1    red  1

        Set `frac` to samples fixed proportions rather than counts:

        >>> df.groupby("a")["b"].samples(frac=0.5, random_state=2)
        5    5
        2    2
        0    0
        Name: b, dtype: int64

        Control samples probabilities within groups by setting weights:

        >>> df.groupby("a").samples(
        ...     n=1,
        ...     weights=[1, 1, 1, 0, 0, 1],
        ...     random_state=1,
        ... )
